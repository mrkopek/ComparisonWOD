...
from data_util import ModelNet40, ScanObjectNN,WashingtonDataset
...
def train(args):
    ...
    if args.dataset == 'ModelNet40':
        ...
        train_loader = DataLoader(WashingtonDataset(partition='training'), num_workers=8,
                                batch_size=64, shuffle=True, drop_last=True)
        test_loader = DataLoader(WashingtonDataset(partition='test'), num_workers=8,
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for data, label in tqdm(train_loader):
            ...
            if args.beta > 0 and r < args.rsmix_prob:
                ...
                if args.dataset == 'ScanObjectNN' or args.dataset == 'Washington':
